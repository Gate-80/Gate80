...
imputer = joblib.load("model/if_imputer.pkl")
scaler = joblib.load("model/if_scaler.pkl")
features = joblib.load("model/if_features.pkl")
...
# Optional scores for inspection
